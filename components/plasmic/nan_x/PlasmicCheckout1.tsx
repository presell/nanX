      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <Embed
            ...
            code={
              '<!-- Google Maps JS + Places library -->\n<script\n  async\n  defer\n  src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBTZd_zfrv4PUMtChBplfplIxSN7VXG-q4&libraries=places&loading=async">\n</script>\n\n<script>\n  function initAutocomplete() {\n    const input = document.getElementById("address-input");\n    if (!input) {\n      console.log("[AC] input not found");\n      return;\n    }\n\n    console.log("[AC] Attaching autocomplete to:", input);\n\n    const ac = new google.maps.places.Autocomplete(input, {\n      // optional but nice to keep it light\n      fields: ["formatted_address", "address_components", "geometry"],\n    });\n\n    ac.addListener("place_changed", () => {\n      const place = ac.getPlace();\n      console.log("[AC] place_changed:", place);\n      // just show what Google picked in the console for now\n    });\n  }\n\n  const interval = setInterval(() => {\n    if (\n      window.google &&\n      google.maps &&\n      google.maps.places &&\n      document.getElementById("address-input")\n    ) {\n      initAutocomplete();\n      clearInterval(interval);\n      console.log("[AC] READY \u2013 attached");\n    }\n  }, 300);\n</script>'
            }
          />
        </div>
      </div>
