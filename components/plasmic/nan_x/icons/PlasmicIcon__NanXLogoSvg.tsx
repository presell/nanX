...
export type NanXLogoSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function NanXLogoSvgIcon(props: NanXLogoSvgIconProps) {
...
export default NanXLogoSvgIcon;
/* prettier-ignore-end */
